...
namespace BannerlordTales
{
   public class StoryRules
   {
      ...
      public bool IsNotRestricted()
      {
         ...
         foreach (IEvaluation restriction in Story.Restrictions)
         {
      ...
      public bool IsTheRightStoryType(StoryType storyType)
      {
         switch (storyType)
         {
            case StoryType.PLAYER_IS_CAPTIVE:      return GameData.Instance.GameContext.PlayerIsCaptive != null && (bool) GameData.Instance.GameContext.PlayerIsCaptive;

...
namespace TalesEntities.TW
{
    public class BaseSettlement : ISettlement
    {
        ...
        public BaseSettlement(Settlement heroBornSettlement)
        {
        ...
        public IList<IHero> HeroesWithoutParty { get; set; }
        ...
        public IMobileParty oldMilitaParty { get; set; }
        ...
        public void AddBoundParty(IMobileParty mobileParty)
        {
            throw new NotImplementedException();
        }
        ...
        public void RemoveBoundParty(IMobileParty mobileParty)
        {
            throw new NotImplementedException();
        }
